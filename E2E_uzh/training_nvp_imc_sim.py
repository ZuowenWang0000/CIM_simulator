...
if __name__ == '__main__':
    ...
    # evaluate the model
    from evaluation_imc_sim import evaluate_saved_model
    metrics = evaluate_saved_model(cfg, visualize=None, savefig=False, bn_folding=False)
    print("final evaluation on the validation set on the best model")
    print(metrics)
