...
import torchvision
import torch
import utils,training_nvp_imc_sim,model, NVP_v1_model_imc_sim
...
def evaluate_saved_model(cfg, visualize=None, savefig=False, bn_folding=False):
    ...
    # Load configurations
    models, dataset, optimization, train_settings = training_nvp_imc_sim.initialize_components(cfg)
...
if __name__ == '__main__':
    ...
    # print("Folding batch norm layers...")
    # metrics = evaluate_saved_model(cfg, 5, savefig=True, bn_folding=True)
    # print(metrics)
